/* Vendored from npm "qrcode" v1.5.4 (MIT License, Ryan Day) -- bundled
   with esbuild for offline, dependency-free use in this static admin
   panel (no CDN calls, matching the app's offline-first architecture).
