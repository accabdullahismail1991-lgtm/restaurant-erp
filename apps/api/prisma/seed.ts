...
const PERMISSIONS: Array<{ code: string; label: string }> = [
  ...
  { code: 'pos.override_kitchen_block', label: 'تجاوز حظر إرجاع صنف لم يخرج من المطبخ بعد (صلاحية إدارية)' },
  { code: 'pos.void_paid_order', label: 'إلغاء فاتورة مدفوعة بالكامل (صلاحية إدارية)' },
