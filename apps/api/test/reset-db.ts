...
//
// NOTE for whoever builds Transfers or Stocktake next: those tables
// (Transfer/TransferLine, Stocktake/StocktakeLine) also FK into
// Ingredient/Location and currently sit empty because nothing writes to
// them yet -- add their deleteMany calls here, in the same
// children-before-parents order, the day a suite starts creating rows in
// them.
